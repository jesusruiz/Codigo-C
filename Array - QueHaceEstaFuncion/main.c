...
int main(void)
{
    ...
    //Llamada la función unaFuncion pasandole como argumentos el array a, el indice de inicio 0 y el tamaño del array
...
void unaFuncion(const int b[], size_t indiceInicio, size_t tamano) {
    ...
    unaFuncion(b, indiceInicio + 1, tamano);  //esta función se llama a sí misma el numero de elementos del array
